...
Through this program, we provide structured academic support to students in under-resourced families
...
We also engage parents and guardians as active partners in their children's education, building a home environment that values and reinforces learning`,
    ...
    impact: "Over 10 students supported annually across 5 learning centres",
  },
  {
...
We stock each reading centre with age-appropriate books in both English and Swahili. Beyond books, we introduce learners to digital literacy tools and storytelling activities that make reading an exciting, social experience
...
For those with entrepreneurial ambitions, we offer a dedicated track that covers business ideation, lean planning, and access to startup support networks`,
    ...
    impact: "30+ youth trained, with 60% reporting improved employment or business prospects within 6 months",
  },
  {
...
The program is especially focused on young women and youth-headed households, recognising that economic independence is inseparable from dignity and community wellbeing`,
    ...
    impact: "1 graduate running active small businesses, with an average monthly income increase of 40%",
  },
];
